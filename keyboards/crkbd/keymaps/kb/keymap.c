...
[_BASE] = LAYOUT_split_3x6_3(
    ...
    KC_J,           KC_L,           KC_U,           KC_Y,           KC_QUOTE,    XXXXXXX,
    XXXXXXX,        MTLG(KC_A),     MTLA(KC_R),     MTLC(KC_S),     MTLS(KC_T),     KC_G,
    KC_M,           MTRS(KC_N),     MTRC(KC_E),     MTRA(KC_I),     MTRG(KC_O),  XXXXXXX,
...
[_QWERTY] = LAYOUT_split_3x6_3(
    ...
    XXXXXXX,        MTLG(KC_A),     MTLA(KC_S),     MTLC(KC_D),     MTLS(KC_F),     KC_G,
    KC_H,           MTRS(KC_J),     MTRC(KC_K),     MTRA(KC_L),     MTRG(KC_QUOT),  XXXXXXX,
...
[_NAV] = LAYOUT_split_3x6_3(
    ...
    XXXXXXX,        KC_LGUI,        KC_LALT,        KC_LCTL,        KC_LSFT,        KC_TRNS,
...
[_MOUSE] = LAYOUT_split_3x6_3(
    ...
    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        XXXXXXX,
    XXXXXXX,        KC_LGUI,        KC_LALT,        KC_LCTL,        KC_LSFT,        KC_TRNS,
    KC_TRNS,        KC_MS_L,        KC_MS_D,        KC_MS_U,        KC_MS_R,        XXXXXXX,
    XXXXXXX,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
    KC_TRNS,        KC_WH_L,        KC_WH_D,        KC_WH_U,        KC_WH_R,        XXXXXXX,
                                    KC_TRNS,        KC_TRNS,        KC_TRNS,
    KC_BTN1,        KC_BTN2,        KC_BTN3
),
[_MEDIA] = LAYOUT_split_3x6_3(
    XXXXXXX,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
    RGB_TOG,        RGB_MOD,        RGB_HUI,        RGB_SAI,        RGB_VAI,        XXXXXXX,
    XXXXXXX,        KC_LGUI,        KC_LALT,        KC_LCTL,        KC_LSFT,        KC_TRNS,
    KC_TRNS,        KC_MPRV,        KC_VOLD,        KC_VOLU,        KC_MNXT,        XXXXXXX,
    XXXXXXX,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
    NK_TOGG,        KC_MRWD,        KC_BRID,        KC_BRIU,        KC_MFFD,        XXXXXXX,
                                    KC_TRNS,        KC_TRNS,        KC_TRNS,
    KC_MUTE,        KC_MPLY,        KC_MSTP
),
[_NUM] = LAYOUT_split_3x6_3(
    XXXXXXX,        KC_LBRC,        KC_7,           KC_8,           KC_9,           KC_RBRC,
    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        XXXXXXX,
    XXXXXXX,        KC_SCLN,        KC_4,           KC_5,           KC_6,           KC_EQL,
    KC_TRNS,        KC_LSFT,        KC_LCTL,        KC_LALT,        KC_LGUI,        XXXXXXX,
    XXXXXXX,        KC_GRV,         KC_1,           KC_2,           KC_3,           KC_BSLS,
    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        XXXXXXX,
                                    KC_DOT,         KC_0,           KC_MINS,
    KC_TRNS,        KC_TRNS,        KC_TRNS
),
[_FUN] = LAYOUT_split_3x6_3(
    XXXXXXX,        KC_F12,         KC_F7,          KC_F8,          KC_F9,          KC_PSCR,
    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        XXXXXXX,
    XXXXXXX,        KC_F11,         KC_F4,          KC_F5,          KC_F6,          KC_SCRL,
    KC_TRNS,        KC_LSFT,        KC_LCTL,        KC_LALT,        KC_LGUI,        XXXXXXX,
    XXXXXXX,        KC_F10,         KC_F1,          KC_F2,          KC_F3,          KC_PAUS,
    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        XXXXXXX,
                                    KC_TRNS,        KC_TRNS,        KC_TRNS,
    KC_TRNS,        KC_TRNS,        KC_TRNS
),
[_STENO] = LAYOUT_split_3x6_3(
    XXXXXXX,        STN_N1,         STN_N2,         STN_N3,         STN_N4,         STN_N5,
    STN_N6,         STN_N7,         STN_N8,         STN_N9,         STN_NA,         XXXXXXX,
